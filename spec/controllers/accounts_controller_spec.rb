...
describe AccountsController do
  ...
  describe "GET index" do
    it "assigns all accounts as @accounts" do
      Accounts.stub!(:find).with(:all).and_return([mock_accounts])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested accounts as @accounts" do
      Accounts.stub!(:find).with("37").and_return(mock_accounts)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new accounts as @accounts" do
      Accounts.stub!(:new).and_return(mock_accounts)
      get :new
      assigns[:accounts].should equal(mock_accounts)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created accounts as @accounts" do
        Accounts.stub!(:new).with({'these' => 'params'}).and_return(mock_accounts(:save => true))
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved accounts as @accounts" do
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      ...
      it "assigns the accounts as @accounts" do
